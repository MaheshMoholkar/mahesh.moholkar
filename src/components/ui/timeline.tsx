    ...
    <div className="c-space section-spacing" ref={containerRef}>
      ...
      <div ref={ref} className="relative pb-20">
        ...
        <div
          ...
          className="absolute left-6 md:left-8 top-10 md:top-40 w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] z-0"
        >
          <motion.div
            style={{
        ...
        {data.map((item, index) => (
          ...
          >
            {/* Circle Dot */}
            <div className="absolute left-2 md:left-7 top-10 md:top-40 z-5">
            ...
            <div className="hidden md:flex sticky top-40 self-start max-w-xs lg:max-w-sm w-full pl-16">
